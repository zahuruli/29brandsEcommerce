...
import ecommerceimg from "../../components/images/Login_SignUp/ecommerce.jpg";
import companylogo from "../../components/images/Login_SignUp/logo.png";
import "./sign_up.css";
...
const SignUp = () => {
  ...
  const handleFromSubmit = async (event) => {
    ...
    // 194.233.87.22/1002/api/auth/signup
    try {
      await fetch("http://194.233.87.22:1002/api/auth/signup", {
        method: "POST",
        headers: {
  ...
  const handleOtp = async (event) => {
    ...
    try {
      await fetch("http://194.233.87.22:1002/api/auth/otp", {
        method: "POST",
        headers: {
          "Content-type": "application/json",
        },
  ...
  return (
    <div className="full_div_register_page">
      <img className="img-full-view" src={ecommerceimg} alt="" />
      <div className="bg-tranparant-background"></div>
      <div className="container_ecommerce_register">
        <div className="container_ecommerce_all">
          ...
          <div className="logo-register-container">
            <img className="ecommerce-logo-register" src={companylogo} alt="" />
            <div className="bg-tranparant-register"></div>
          </div>

          {/* Start Form Register */}
          <form className="from_ecommerce_register" action="">
            <div className="input_field_ecommerce_register">
              <input
                type="text"
            ...
            <div
              className="input_field_ecommerce_register"
              style={{
                display: "flex",
                flexDirection: "row",
                alignItems: "center",
